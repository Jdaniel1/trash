 ...
 */
 function updateYearPicker($input)
 {
	...
	let html = '<div class="d-flex justify-content-between align-items-center datepicker-btns">'
		...
		+ '<a id="' + input_id + '-picker-prev-link" class="btn btn-link px-1 mx-0' + ((!options.minDate || options.minDate.isBefore(startDate, 'date')) ? '' : ' disabled') + '" href="javascript:void(0)" title="Go to Previous Years"><i class="fa fa-chevron-left fa-fw"></i></a>'
		...
		+ '<a id="' + input_id + '-picker-next-link" class="btn btn-link px-1 mx-0' + ((!options.maxDate || options.maxDate.isAfter(endDate, 'date')) ? '' : ' disabled') + '" href="javascript:void(0)" title="Go to Next Years"><i class="fa fa-chevron-right fa-fw"></i></a>'
		+ '</div></div>'
 ...
 function updateMonthPicker($input)
 {
	...
	let html = '<div class="d-flex justify-content-between align-items-center datepicker-btns">'
		...
		+ '<a id="' + input_id + '-picker-prev-link" class="btn btn-link px-1 mx-0' + ((!options.minDate || options.minDate.isBefore(viewDate.startOf('year'), 'date')) ? '' : ' disabled') + '" href="javascript:void(0)" title="Go to Previous Year" data-unit="month"><i class="fa fa-chevron-left fa-fw"></i></a>'
		...
		+ '<a id="' + input_id + '-picker-next-link" class="btn btn-link px-1 mx-0' + ((!options.maxDate || options.maxDate.isAfter(viewDate.endOf('year'), 'date')) ? '' : ' disabled') + '" href="javascript:void(0)" title="Go to Next Year" data-unit="month"><i class="fa fa-chevron-right fa-fw"></i></a>'
		+ '</div></div>'
...
function updateDatePicker($input)
{
	...
	let html = '<div class="d-flex justify-content-between align-items-center datepicker-btns">'
		...
		+ '<a id="' + input_id + '-picker-prev-link" class="btn btn-link px-1 mx-0' + ((!options.minDate || options.minDate.isBefore(viewDate.startOf('month'), 'date')) ? '' : ' disabled') + '" href="javascript:void(0)" title="Go to Previous Month" data-unit="month"><i class="fa fa-chevron-left fa-fw"></i></a>'
		...
		+ '<a id="' + input_id + '-picker-next-link" class="btn btn-link px-1 mx-0' + ((!options.maxDate || options.maxDate.isAfter(viewDate.endOf('month'), 'date')) ? '' : ' disabled') + '" href="javascript:void(0)" title="Go To Next Month" data-unit="month"><i class="fa fa-chevron-right fa-fw"></i></a>'
		+ '</div></div>'
